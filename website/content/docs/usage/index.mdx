...
> [!TIP]
>
> GraphQL Config uses [`GraphQL Tools`](https://the-guild.dev/graphql/tools) under the hood to
...
> project, the GraphQL-ESLint's parser will automatically use him to load your GraphQL schema.
>
> Alternatively you can pass GraphQL Config options programmatically via
> `languageOptions.parserOptions.graphQLConfig` in the `eslint.config.js` file.
