...
### Lint GraphQL Definitions in Code Files[^1] _(Optional)_
...
### Extended Linting Rules with GraphQL Schema _(Optional)_
...
### Extended Linting Rules with Siblings Operations _(Optional)_
