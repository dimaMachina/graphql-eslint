...
[no-unreachable-types](../rules/no-unreachable-types) checks that
...
`graphql-eslint` integrates with [`graphql-config`](https://the-guild.dev/graphql/config) automatically and will use it to load your schema!
