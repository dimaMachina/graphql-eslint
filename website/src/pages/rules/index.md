...
[nullable-records](/rules/nullable-records)|Enforces users to return types that conform to Node interface as nullable. These types can usually be deleted from Relay cache and schema should reflect that.|![recommended][]|📄|🚀|💡
